        ...
        <div class="app-header-wrapper d-flex flex-grow-1 align-items-stretch justify-content-between" id="kt_app_header_wrapper">
            ...
            <div class="app-header-logo d-flex flex-shrink-0 align-items-center justify-content-between justify-content-lg-center">
                ...
                <a href="{{ route('lawyer.dashboard') }}">
                    <img alt="Logo" src="{{ asset('lawyer-assets/media/logos/default-small.svg') }}" class="h-30px h-lg-40px theme-light-show" />
                    <img alt="Logo" src="{{ asset('lawyer-assets/media/logos/default-small-dark.svg') }}" class="h-30px h-lg-40px theme-dark-show" />
                </a>
                <!--end::Logo image-->
            </div>
            <!--end::Logo wrapper-->
...
{{--                        </div>--}}
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{ route('lawyer.auth.logout') }}" class="menu-link px-5">تسجيل الخروج</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
