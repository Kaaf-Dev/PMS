                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="d-flex justify-content-center">
                                    <!--begin::Input-->
                                    <div>
                                        <button wire:click="loadReceipts" class="btn btn-primary">بحث</button>
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                    ...
                    @if($receipts)
                        ...
                        @forelse($receipts as $receipt)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.users.details', ['user_id' => $receipt->Invoice->Contract->User->id]) }}"
                                       class="text-gray-800 text-hover-primary mb-1">{{ $receipt->Invoice->Contract->User->name ?? '' }}</a>
                                </td>
                                <!--end::Property-->
                                ...
                                <!--begin::Action=-->
                                <td class="text-end">
                                        <button wire:click="printReceipt({{$receipt->id}})"
