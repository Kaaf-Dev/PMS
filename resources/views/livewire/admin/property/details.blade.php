            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-column flex-lg-row-auto w-lg-250px w-xl-350px mb-10">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        @livewire('admin.property.details.info', ['property' => $this->property], key($this->property->id))
                    </div>
                </div>
                <!--end::Sidebar-->
                <!--begin::Content-->
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true"
                               data-bs-toggle="tab" href="#kt_user_view_overview_tab">الإعدادات</a>
                        </li>
                        <!--end:::Tab item-->
                ...
                <path
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade active show" id="kt_user_view_overview_security" role="tabpanel">
                            <!--begin::Card-->
                            @livewire('admin.property.details.overview', ['property' => $this->property], key($this->property->id))
                            <!--end::Card-->
                        </div>
                        <!--end:::Tab pane-->
