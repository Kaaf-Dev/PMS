        ...
        <div id="kt_user_view_details" class="collapse show">
            ...
            <div class="mt-5">
                <div class="row g-xl-5">
                    ...
                    @if($this->property->IsTypeProperty)
                        <div class="col-xl-6 col-md-12">
                            <!--begin::Stat-->
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mb-3 text-center">
                                <!--begin::Number-->
                    ...
                    @else
                        ...
                        <div class="col-xl-6 col-md-12">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mb-3 text-center">
                                ...
                                <!--begin::Label-->
                                <div class="fw-semibold fs-4 text-dark-400">{{ $this->property->register_number }}</div>
                                <div class="fw-semibold fs-6 text-gray-400">رقم المقدمة</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                        </div>
                        ...
                        <div class="col-xl-12 col-md-12">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mb-3 text-center">
                                ...
                                <!--begin::Label-->
                                <div class="fw-semibold fs-4 text-dark-400">{{ $this->property->register_year }}</div>
                                <div class="fw-semibold fs-6 text-gray-400">سنة المقدمة</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                        </div>
