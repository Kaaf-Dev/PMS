<div>
    <form wire:submit.prevent="submit">
        ...
        <div class="d-flex flex-column mb-8 fv-row">
            ...
            <!--end::Label-->
            <select wire:model="selected_user_id" id="users_list" class="form-select form-select">
        ...
        <div class="row g-9 mb-8">
            ...
            <div class="col-md-6 fv-row">
                ...
                <select wire:model="selected_property" class="form-select form-select">
            ...
            <div class="col-md-6 fv-row">
                ...
                <select wire:model.defer="selected_contract_apartment" class="form-select form-select">
                    <option value="">-- اختيار --</option>
