    ...
    <form wire:submit.prevent="search">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!--begin::Input group-->
                <div class="mb-8">
                    <label class="fs-6 form-label fw-bold text-dark">المستأجر</label>
                    <!--begin::Select-->
                    <select wire:model.defer="user_id" class="form-select form-select-solid">
                        <option value="">الجميع</option>
                ...
                <div class="mb-8">
                    ...
                    <div class="nav-group nav-group-fluid">
                        ...
                        <!--begin::Option-->
                        <label>
                            <input wire:model.defer="visit_in" name="ticket_category" type="radio" class="btn-check" value="all" />
                            <span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4">الجميع</span>
                        </label>
                        <!--end::Option-->
                    </div>
                    <!--end::Radio group-->
