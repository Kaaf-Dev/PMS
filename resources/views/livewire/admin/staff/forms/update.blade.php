    ...
    <form wire:submit.prevent="save" class="form">
        ...
        <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
            ...
            <div class="fv-row mb-7">
                ...
                <!--begin::Input-->
                <input type="text" wire:model.defer="Admin.name" class="form-control form-control-solid" required/>
                <!--end::Input-->
                @error('Admin.name')
            ...
            <div class="fv-row mb-7">
                ...
                <!--begin::Input-->
                <input type="email" wire:model.defer="Admin.username" class="form-control form-control-solid" required/>
                <!--end::Input-->
