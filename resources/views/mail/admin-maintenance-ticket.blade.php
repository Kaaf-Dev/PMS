...
<p>
    You can login the PMS system by <a
        href="{{route('admin.tickets.details', ['ticket_id' => $ticket->id, 'notification_id' => $notification_id])}}" style="color: #0a58ca;"><u>click here</u></a>
</p>
