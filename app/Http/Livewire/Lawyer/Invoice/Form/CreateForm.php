...
class CreateForm extends Component
{
    ...
    public function rules()
    {
        return [
            ...
            'court_fees' => 'required|numeric',
            'executor_fees' => 'required|numeric',
            'attorneys_fees' => 'required|numeric',
    ...
    {
        return [
            'show-lawyer-invoice-create-form-modal' => 'resolveParams',
        ];
    }

    public function render()
    {
        return view('livewire.lawyer.invoice.form.create-form');
    }
    ...
    {
        $this->resetFields();
        $this->emit('hide-lawyer-invoice-create-form-modal');
    }
}
